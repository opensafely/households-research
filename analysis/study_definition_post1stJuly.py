...
study = StudyDefinition(
    ...
    has_12_m_follow_up=patients.registered_with_one_practice_between(
        "2019-07-01",
        "2020-07-01",  ### 12 months prior to 1st July 2020
        return_expectations={
            "incidence": 0.95,
        },
    ),
    ...
    first_tested_for_covid=patients.with_test_result_in_sgss(
        ...
        return_expectations={"date": {"earliest" : "2020-07-01"},
    ...
    covid_admission_date=patients.admitted_to_hospital(
        ...
        find_first_match_in_period=True,
        date_format="YYYY-MM-DD",
        return_expectations={"date": {"earliest": "2020-07-01"}, "incidence": 0.95},
    ),
