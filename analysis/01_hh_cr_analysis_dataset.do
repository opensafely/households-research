...
PROJECT:				Development of a household SARS-CoV-2 transmission model
...
==============================================================================*/
/*dummy data only
cd /Users/kw/Documents/GitHub/households-research/expectations-master-dummy-local/generate_cohort/cohort
clear all
import delimited /Users/kw/Documents/GitHub/households-research/expectations-master-dummy-local/generate_cohort/cohort/input.csv
*/
...
*keep the variables I need for the hh_transmissionModel_analysis
/*
...
*/
keep patient_id age ageCat hh_id hh_size hh_composition case_date case eth5 eth16 ethnicity_16 indexdate sex imd region shielding rural_urban
...
save hhTransmissionModel_analysis_dataset.dta, replace
